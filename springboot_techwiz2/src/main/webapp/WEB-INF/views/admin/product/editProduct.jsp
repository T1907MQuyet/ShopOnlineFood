...
<%--@elvariable id="proEdit" type=""--%>
<f:form action="${pageContext.request.contextPath}/admin/product/updatePro" method="POST" enctype="multipart/form-data" modelAttribute="proEdit">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-10">
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        <f:input path="product_id" type="hidden"/>
                        <f:input path="created" type="hidden"/>
                        <div class="col-md-12">
                            <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="exampleInputEmail1">Product Name:</label>
                                        <f:input path="product_name" type="text"  class="form-control " placeholder="Enter product name"/>
                                    </div>
                                <div class="form-group col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <f:input path="priority" type="number" class="form-control " placeholder="Enter priority..."/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
