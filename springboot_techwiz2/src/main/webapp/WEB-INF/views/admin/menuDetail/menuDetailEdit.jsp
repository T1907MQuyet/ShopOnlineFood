            ...
            <div class="col-md-5">
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Edit Menu Detail!</h3>
                    ...
                    <div class="card-body" style="display: block;">
                        <!-- /.card-header -->
                        <!-- form start -->
                        <%--@elvariable id="menDetailEdit" type=""--%>
                        <f:form action="${pageContext.request.contextPath}/admin/menuDetail/updateMenuDetail" method="POST" modelAttribute="menDetailEdit">
                            <f:input path="menu_detail_id" type="hidden"/>
                            ...
                            <div class="form-group">
                                ...
                                <f:select cssClass="custom-select" path="menu.menu_id">
                                    <f:options items="${list}" itemLabel="menu_name" itemValue="menu_id"/>
                                </f:select>
                            </div>
                                <div class="form-group">
                                    <label>Status:</label>
